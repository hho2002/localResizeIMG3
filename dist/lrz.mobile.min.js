...
!function(){function t(t,e,a){if(this.file=t,this.callback=a,this.defaults={quality:7},a){for(var i in e)this.defaults[i]=e[i];this.defaults.quality>10&&(this.defaults.quality=10)}else this.callback=e;this.results={blob:null,origin:null,base64:null},this.init()}window.URL=window.URL||window.webkitURL;var e=navigator.userAgent;t.prototype={constructor:t,init:function(){var t=this;t.create(t.file,t.callback)},create:function(t,a){var i=this,h=new Image,r=i.results,n=URL.createObjectURL(t);h.onload=function(){var s,l=i.resize(this),o=document.createElement("canvas");if(o.width=l.w,o.height=l.h,s=o.getContext("2d"),/iphone/i.test(e))try{var w=new MegaPixImage(h);w.render(o,{maxWidth:o.width,maxHeight:o.height,quality:i.defaults.quality})}catch(c){throw Error("未引用mobile补丁，无法生成图片。")}EXIF.getData(h,function(){var w=EXIF.pretty(this).match(/Orientation : (\d)/),c=w?+w[1]:1;switch(c){case 3:s.rotate(180*Math.PI/180),s.drawImage(h,-l.w,-l.h,l.w,l.h);break;case 6:o.width=l.h,o.height=l.w,s.rotate(90*Math.PI/180),s.drawImage(h,0,-l.h,l.w,l.h);break;case 8:o.width=l.h,o.height=l.w,s.rotate(270*Math.PI/180),s.drawImage(h,-l.w,0,l.w,l.h);break;default:s.drawImage(h,0,0,l.w,l.h)}if(r.blob=n,r.origin=t,/Android/i.test(e))try{var d=new JPEGEncoder;r.base64=d.encode(s.getImageData(0,0,o.width,o.height),100*i.defaults.quality)}catch(u){throw Error("未引用mobile补丁，无法生成图片。")}else r.base64=o.toDataURL("image/jpeg",i.defaults.quality);a(r)})},h.src=n},resize:function(t){var e=this.defaults.width,a=this.defaults.height,i=t.width/t.height,h={w:t.width,h:t.height};return e&a?(h.w=e,h.h=a):e?(h.w=e,h.h=Math.ceil(e/i)):a&&(h.w=Math.ceil(a*i),h.h=a),h}},window.lrz=function(e,a,i){return new t(e,a,i)}}();